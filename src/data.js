...
const fromActivity = (r) => ({
  ...
  subArea: r.sub_area || "", tier3: r.tier3 || "", asset: r.asset || "", discipline: (r.discipline ? String(r.discipline).split(/\s*;\s*/).filter(Boolean) : []), witnessInvite: !!r.witness_invite, witnessType: r.witness_type || "", witnessAt: r.witness_at || "", witnessDurationMin: (r.witness_duration_min == null ? 60 : Number(r.witness_duration_min)), witnessDays: (r.witness_days == null ? 1 : Math.max(1, Number(r.witness_days))), witnessSentAt: r.witness_sent_at || "", notes: r.notes || "", slipReason: r.slip_reason || "",
